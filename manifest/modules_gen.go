...
import (
	...
	ext_codex_deepseek "github.com/rzbdz/newgate-ext/modules/codex_deepseek"
	...
	ext_home "github.com/rzbdz/newgate-ext/modules/home"
	...
	return map[string]app.Selection{
		"dist-dashboard.json": {
			...
			Extra: []app.Entry{
				...
				{Dir: "home", Component: ext_home.New()},
